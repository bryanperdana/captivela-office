...
export const strings = {
  zh: {
    ...
    noContent: '（无内容）',
    // Account
    accountGenspark: 'Captivela 账号',
    account: '账号',
    login: '登录',
    loginGenspark: '登录 Captivela 账号',
    loggedIn: '已登录',
    loggedInGenspark: '已登录 Captivela',
    ...
    loginCopyUrl: '复制登录链接',
    loginCopied: '已复制',
    loginNetworkError: '无法连接 Captivela,请检查网络或代理设置',
    ...
    onbTitle1: '欢迎使用 Captivela Office',
    onbSubtitle1: '第一个开源的 AI 原生 Office 套件',
    onbBody1: '创建文档、制作表格、生成演示、审阅 PDF。AI 深度融入每个环节。',
    onbTitle2: '这只是一个开始',
    onbBody2:
      'Captivela Office 目前处于 alpha 阶段。欢迎加入 Captivela Community 群聊，分享反馈，一起塑造它的未来。',
    onbCredits: '活跃贡献者可获得 **1,000+ Captivela 积分**',
    onbJoinGenTeam: '加入 Captivela Community',
    onbSkip: '跳过',
    onbNext: '下一步',
    onbStart: '开始使用',
    ...
    onbNote3: 'AI 功能可能消耗 Captivela 积分。',
    onbBack: '上一步',
  },
  en: {
    navRecent: 'Recent',
    ...
    untitled: 'Untitled',
    noContent: '(empty)',
    accountGenspark: 'Captivela Account',
    account: 'Account',
    login: 'Sign in',
    loginGenspark: 'Sign in with Captivela',
    loggedIn: 'Signed in',
    loggedInGenspark: 'Signed in to Captivela',
    ...
    loginCopied: 'Copied',
    loginNetworkError: 'Cannot reach Captivela — check your network or proxy settings',
    ...
    newTab: 'New tab',
    // First-run onboarding
    onbTitle1: 'Welcome to Captivela Office',
    ...
    onbBody2:
      'Captivela Office is still in alpha. Join the group chat on Captivela Community to share feedback and help shape what comes next.',
    onbCredits: 'Active contributors get **1,000+ Captivela credits**',
    onbJoinGenTeam: 'Join Captivela Community',
    onbSkip: 'Skip',
    onbNext: 'Next',
    ...
    onbNote3: 'AI features may consume Captivela credits.',
    onbBack: 'Back',
  },
  ja: {
    // Sidebar navigation
    ...
    noContent: '（内容なし）',
    // Account
    accountGenspark: 'Captivela アカウント',
    account: 'アカウント',
    login: 'サインイン',
    loginGenspark: 'Captivela アカウントでサインイン',
    loggedIn: 'サインイン済み',
    loggedInGenspark: 'Captivela にサインイン済み',
    waitingLogin:
    ...
    loginCopied: 'コピーしました',
    loginNetworkError:
      'Captivela に接続できません。ネットワークまたはプロキシ設定を確認してください',
    ...
    newTab: '新しいタブ',
    // First-run onboarding
    onbTitle1: 'Captivela Office へようこそ',
    onbSubtitle1: '初のオープンソース AI ネイティブ Office スイート',
    onbBody1:
      '文書の作成、表計算、プレゼン作成、PDF のレビュー。あらゆるステップに AI が組み込まれています。',
    onbTitle2: 'これはまだ始まりにすぎません',
    onbBody2:
      'Captivela Office はまだアルファ版です。Captivela Community のグループチャットに参加して、フィードバックを共有し、今後の開発を一緒に形作りましょう。',
    onbCredits: 'アクティブな貢献者への特典 **1,000+ Captivela クレジット**',
    onbJoinGenTeam: 'Captivela Community に参加',
    onbSkip: 'スキップ',
    onbNext: '次へ',
    onbStart: 'はじめる',
    ...
    onbNote3: 'AI 機能は Captivela クレジットを消費する場合があります。',
    onbBack: '戻る',
  },
  ko: {
    // Sidebar navigation
    ...
    noContent: '(내용 없음)',
    // Account
    accountGenspark: 'Captivela 계정',
    account: '계정',
    login: '로그인',
    loginGenspark: 'Captivela 계정으로 로그인',
    loggedIn: '로그인됨',
    loggedInGenspark: 'Captivela에 로그인됨',
    ...
    loginCopied: '복사됨',
    loginNetworkError: 'Captivela에 연결할 수 없습니다. 네트워크 또는 프록시 설정을 확인하세요',
    ...
    newTab: '새 탭',
    // First-run onboarding
    onbTitle1: 'Captivela Office에 오신 것을 환영합니다',
    onbSubtitle1: '최초의 오픈소스 AI 네이티브 오피스 제품군',
    onbBody1:
      '문서 작성, 스프레드시트 제작, 프레젠테이션 생성, PDF 검토. 모든 단계에 AI가 녹아 있습니다.',
    onbTitle2: '이제 시작일 뿐입니다',
    onbBody2:
      'Captivela Office는 아직 알파 단계입니다. Captivela Community 그룹 채팅에 참여해 피드백을 공유하고 앞으로의 방향을 함께 만들어 가세요.',
    onbCredits: '활발한 기여자를 위한 혜택 **1,000+ Captivela 크레딧**',
    onbJoinGenTeam: 'Captivela Community 참여하기',
    onbSkip: '건너뛰기',
    onbNext: '다음',
    onbStart: '시작하기',
    ...
    onbNote3: 'AI 기능은 Captivela 크레딧을 소모할 수 있습니다.',
    onbBack: '이전',
  },
  fr: {
    // Sidebar navigation
    ...
    noContent: '(vide)',
    // Account
    accountGenspark: 'Compte Captivela',
    account: 'Compte',
    login: 'Se connecter',
    loginGenspark: 'Se connecter avec Captivela',
    loggedIn: 'Connecté',
    loggedInGenspark: 'Connecté à Captivela',
    waitingLogin:
    ...
    loginCopied: 'Copié',
    loginNetworkError:
      'Impossible de joindre Captivela — vérifiez votre réseau ou vos paramètres de proxy',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenue dans Captivela Office',
    ...
    onbBody2:
      'Captivela Office est encore en alpha. Rejoignez la discussion de groupe sur Captivela Community pour partager vos retours et façonner la suite.',
    onbCredits: 'Les contributeurs actifs reçoivent **1 000+ crédits Captivela**',
    onbJoinGenTeam: 'Rejoindre Captivela Community',
    onbSkip: 'Passer',
    onbNext: 'Suivant',
    onbStart: 'Commencer',
    ...
    onbNote3: 'Les fonctions IA peuvent consommer des crédits Captivela.',
    onbBack: 'Retour',
  },
  de: {
    // Sidebar navigation
    ...
    noContent: '(leer)',
    // Account
    accountGenspark: 'Captivela-Konto',
    account: 'Konto',
    login: 'Anmelden',
    loginGenspark: 'Mit Captivela anmelden',
    loggedIn: 'Angemeldet',
    loggedInGenspark: 'Bei Captivela angemeldet',
    waitingLogin:
    ...
    loginCopied: 'Kopiert',
    loginNetworkError:
      'Captivela ist nicht erreichbar — prüfen Sie Netzwerk- oder Proxy-Einstellungen',
    ...
    newTab: 'Neuer Tab',
    // First-run onboarding
    onbTitle1: 'Willkommen bei Captivela Office',
    ...
    onbBody2:
      'Captivela Office ist noch in der Alpha-Phase. Treten Sie dem Gruppenchat auf Captivela Community bei, um Feedback zu teilen und die Zukunft mitzugestalten.',
    onbCredits: 'Aktive Mitwirkende erhalten **1.000+ Captivela-Guthaben**',
    onbJoinGenTeam: 'Captivela Community beitreten',
    ...
    onbNote3: 'KI-Funktionen können Captivela-Credits verbrauchen.',
    onbBack: 'Zurück',
  },
  es: {
    // Sidebar navigation
    ...
    noContent: '(vacío)',
    // Account
    accountGenspark: 'Cuenta de Captivela',
    account: 'Cuenta',
    login: 'Iniciar sesión',
    loginGenspark: 'Iniciar sesión con Captivela',
    loggedIn: 'Sesión iniciada',
    loggedInGenspark: 'Sesión iniciada en Captivela',
    waitingLogin:
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'No se puede conectar con Captivela — compruebe su red o la configuración del proxy',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenido a Captivela Office',
    ...
    onbBody2:
      'Captivela Office aún está en alfa. Únete al chat grupal en Captivela Community para compartir comentarios y ayudar a dar forma a lo que viene.',
    onbCredits: 'Los colaboradores activos reciben **1.000+ créditos de Captivela**',
    onbJoinGenTeam: 'Unirse a Captivela Community',
    onbSkip: 'Omitir',
    onbNext: 'Siguiente',
    onbStart: 'Empezar',
    ...
    onbNote3: 'Las funciones de IA pueden consumir créditos de Captivela.',
    onbBack: 'Atrás',
  },
  th: {
    // Sidebar navigation
    ...
    // Account
    accountGenspark: 'บัญชี Captivela',
    account: 'บัญชี',
    login: 'ลงชื่อเข้าใช้',
    loginGenspark: 'ลงชื่อเข้าใช้ด้วย Captivela',
    loggedIn: 'ลงชื่อเข้าใช้แล้ว',
    loggedInGenspark: 'ลงชื่อเข้าใช้ Captivela แล้ว',
    ...
    loginNetworkError: 'ไม่สามารถเชื่อมต่อ Captivela ได้ โปรดตรวจสอบเครือข่ายหรือการตั้งค่าพร็อกซี',
    ...
    newTab: 'แท็บใหม่',
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ Captivela Office',
    ...
    onbBody2:
      'Captivela Office ยังอยู่ในช่วงอัลฟ่า เข้าร่วมแชทกลุ่มบน Captivela Community เพื่อแบ่งปันความคิดเห็นและร่วมกำหนดทิศทางต่อไป',
    onbCredits: 'ผู้มีส่วนร่วมอย่างต่อเนื่องจะได้รับ **เครดิต Captivela กว่า 1,000**',
    onbJoinGenTeam: 'เข้าร่วม Captivela Community',
    onbSkip: 'ข้าม',
    onbNext: 'ถัดไป',
    ...
    onbNote3: 'ฟีเจอร์ AI อาจใช้เครดิต Captivela',
    onbBack: 'ย้อนกลับ',
  },
  id: {
    // Sidebar navigation
    ...
    noContent: '(kosong)',
    // Account
    accountGenspark: 'Akun Captivela',
    account: 'Akun',
    login: 'Masuk',
    loginGenspark: 'Masuk dengan Captivela',
    loggedIn: 'Sudah masuk',
    loggedInGenspark: 'Sudah masuk ke Captivela',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat terhubung ke Captivela — periksa jaringan atau pengaturan proxy Anda',
    ...
    newTab: 'Tab baru',
    // First-run onboarding
    onbTitle1: 'Selamat datang di Captivela Office',
    ...
    onbBody2:
      'Captivela Office masih dalam tahap alpha. Gabung obrolan grup di Captivela Community untuk berbagi masukan dan ikut menentukan arah ke depan.',
    onbCredits: 'Kontributor aktif mendapat **1.000+ kredit Captivela**',
    onbJoinGenTeam: 'Gabung Captivela Community',
    onbSkip: 'Lewati',
    onbNext: 'Berikutnya',
    onbStart: 'Mulai',
    ...
    onbNote3: 'Fitur AI dapat menggunakan kredit Captivela.',
    onbBack: 'Kembali',
  },
  ru: {
    // Sidebar navigation
    ...
    noContent: '(пусто)',
    // Account
    accountGenspark: 'Учётная запись Captivela',
    account: 'Учётная запись',
    login: 'Войти',
    loginGenspark: 'Войти через Captivela',
    loggedIn: 'Вход выполнен',
    loggedInGenspark: 'Выполнен вход в Captivela',
    ...
    loginNetworkError: 'Не удаётся подключиться к Captivela — проверьте сеть или настройки прокси',
    ...
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в Captivela Office',
    ...
    onbBody2:
      'Captivela Office пока в альфа-версии. Присоединяйтесь к групповому чату в Captivela Community, чтобы делиться отзывами и влиять на дальнейшее развитие.',
    onbCredits: 'Активные участники получают **1000+ кредитов Captivela**',
    onbJoinGenTeam: 'Присоединиться к Captivela Community',
    onbSkip: 'Пропустить',
    onbNext: 'Далее',
    onbStart: 'Начать',
    ...
    onbNote3: 'Функции ИИ могут расходовать кредиты Captivela.',
    onbBack: 'Назад',
  },
  ar: {
    // Sidebar navigation
    ...
    noContent: '(فارغ)',
    // Account
    accountGenspark: 'حساب Captivela',
    account: 'الحساب',
    login: 'تسجيل الدخول',
    loginGenspark: 'تسجيل الدخول باستخدام Captivela',
    loggedIn: 'تم تسجيل الدخول',
    loggedInGenspark: 'تم تسجيل الدخول إلى Captivela',
    ...
    loginNetworkError: 'تعذّر الاتصال بـ Captivela — تحقق من الشبكة أو إعدادات الوكيل',
    ...
    // First-run onboarding
    onbTitle1: 'مرحبًا بك في Captivela Office',
    ...
    onbBody2:
      'لا يزال Captivela Office في مرحلة ألفا. انضم إلى الدردشة الجماعية على Captivela Community لمشاركة ملاحظاتك والمساهمة في تشكيل المستقبل.',
    onbCredits: 'يحصل المساهمون النشطون على **+1,000 من أرصدة Captivela**',
    onbJoinGenTeam: 'الانضمام إلى Captivela Community',
    onbSkip: 'تخطي',
    onbNext: 'التالي',
    onbStart: 'ابدأ الآن',
    ...
    onbNote3: 'قد تستهلك ميزات الذكاء الاصطناعي أرصدة Captivela.',
    onbBack: 'رجوع',
  },
  pt: {
    navRecent: 'Recentes',
    ...
    untitled: 'Sem título',
    noContent: '(vazio)',
    accountGenspark: 'Conta Captivela',
    account: 'Conta',
    login: 'Entrar',
    loginGenspark: 'Entrar com a Captivela',
    loggedIn: 'Conectado',
    loggedInGenspark: 'Conectado à Captivela',
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'Não foi possível conectar ao Captivela — verifique sua rede ou as configurações de proxy',
    ...
    newTab: 'Nova guia',
    // First-run onboarding
    onbTitle1: 'Bem-vindo ao Captivela Office',
    ...
    onbBody2:
      'O Captivela Office ainda está em alfa. Entre no chat em grupo no Captivela Community para compartilhar feedback e ajudar a moldar o que vem a seguir.',
    onbCredits: 'Contribuidores ativos recebem **1.000+ créditos Captivela**',
    onbJoinGenTeam: 'Entrar no Captivela Community',
    onbSkip: 'Pular',
    onbNext: 'Avançar',
    onbStart: 'Começar',
    onbStepAria: 'Página {n} de {total}',
    ...
    onbNote3: 'Os recursos de IA podem consumir créditos Captivela.',
    onbBack: 'Voltar',
  },
  it: {
    navRecent: 'Recenti',
    ...
    noContent: '(vuoto)',
    accountGenspark: 'Account Captivela',
    account: 'Account',
    login: 'Accedi',
    loginGenspark: 'Accedi con Captivela',
    loggedIn: 'Accesso effettuato',
    loggedInGenspark: 'Accesso effettuato a Captivela',
    ...
    loginCopied: 'Copiato',
    loginNetworkError:
      'Impossibile raggiungere Captivela — controlla la rete o le impostazioni del proxy',
    ...
    newTab: 'Nuova scheda',
    // First-run onboarding
    onbTitle1: 'Benvenuto in Captivela Office',
    ...
    onbBody2:
      'Captivela Office è ancora in alpha. Unisciti alla chat di gruppo su Captivela Community per condividere feedback e contribuire a plasmare il futuro.',
    onbCredits: 'I collaboratori attivi ricevono **1.000+ crediti Captivela**',
    onbJoinGenTeam: 'Unisciti a Captivela Community',
    onbSkip: 'Salta',
    onbNext: 'Avanti',
    onbStart: 'Inizia',
    ...
    onbNote3: 'Le funzioni IA possono consumare crediti Captivela.',
    onbBack: 'Indietro',
  },
  pl: {
    navRecent: 'Ostatnie',
    ...
    untitled: 'Bez tytułu',
    noContent: '(pusto)',
    accountGenspark: 'Konto Captivela',
    account: 'Konto',
    login: 'Zaloguj się',
    loginGenspark: 'Zaloguj się przez Captivela',
    loggedIn: 'Zalogowano',
    loggedInGenspark: 'Zalogowano do Captivela',
    waitingLogin:
    ...
    loginNetworkError: 'Nie można połączyć się z Captivela — sprawdź sieć lub ustawienia proxy',
    ...
    newTab: 'Nowa karta',
    // First-run onboarding
    onbTitle1: 'Witamy w Captivela Office',
    ...
    onbBody2:
      'Captivela Office jest wciąż w fazie alfa. Dołącz do czatu grupowego na Captivela Community, aby dzielić się opiniami i współtworzyć jego przyszłość.',
    onbCredits: 'Aktywni współtwórcy otrzymują **1000+ kredytów Captivela**',
    onbJoinGenTeam: 'Dołącz do Captivela Community',
    onbSkip: 'Pomiń',
    onbNext: 'Dalej',
    onbStart: 'Rozpocznij',
    ...
    onbNote3: 'Funkcje AI mogą zużywać kredyty Captivela.',
    onbBack: 'Wstecz',
  },
  nl: {
    navRecent: 'Recent',
    ...
    account: 'Account',
    login: 'Inloggen',
    loginGenspark: 'Inloggen met Captivela',
    loggedIn: 'Ingelogd',
    loggedInGenspark: 'Ingelogd bij Captivela',
    ...
    loginNetworkError: 'Kan Captivela niet bereiken — controleer uw netwerk of proxyinstellingen',
    ...
    // First-run onboarding
    onbTitle1: 'Welkom bij Captivela Office',
    ...
    onbBody2:
      'Captivela Office is nog in alfa. Doe mee aan de groepschat op Captivela Community om feedback te delen en mee te bepalen wat er komt.',
    onbCredits: 'Actieve bijdragers krijgen **1.000+ Captivela-credits**',
    onbJoinGenTeam: 'Word lid van Captivela Community',
    onbSkip: 'Overslaan',
    onbNext: 'Volgende',
    ...
    onbNote3: 'AI-functies kunnen Captivela-credits verbruiken.',
    onbBack: 'Terug',
  },
  ms: {
    navRecent: 'Terkini',
    ...
    noContent: '(kosong)',
    accountGenspark: 'Akaun Captivela',
    account: 'Akaun',
    login: 'Log masuk',
    loginGenspark: 'Log masuk dengan Captivela',
    loggedIn: 'Telah log masuk',
    loggedInGenspark: 'Telah log masuk ke Captivela',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat menyambung ke Captivela — semak rangkaian atau tetapan proksi anda',
    ...
    newTab: 'Tab baharu',
    // First-run onboarding
    onbTitle1: 'Selamat datang ke Captivela Office',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'Captivela Office masih dalam peringkat alfa. Sertai sembang kumpulan di Captivela Community untuk berkongsi maklum balas dan membentuk masa depannya.',
    onbCredits: 'Penyumbang aktif menerima **1,000+ kredit Captivela**',
    onbJoinGenTeam: 'Sertai Captivela Community',
    onbSkip: 'Langkau',
    onbNext: 'Seterusnya',
    onbStart: 'Mula',
    ...
    onbNote3: 'Ciri AI mungkin menggunakan kredit Captivela.',
    onbBack: 'Kembali',
  },
  he: {
    navRecent: 'אחרונים',
    ...
    untitled: 'ללא שם',
    noContent: '(ריק)',
    accountGenspark: 'חשבון Captivela',
    account: 'חשבון',
    login: 'התחברות',
    loginGenspark: 'התחברות עם Captivela',
    loggedIn: 'מחובר',
    loggedInGenspark: 'מחובר ל-Captivela',
    ...
    loginCopied: 'הועתק',
    loginNetworkError: 'לא ניתן להתחבר ל-Captivela — בדקו את הרשת או את הגדרות ה-proxy',
    ...
    // First-run onboarding
    onbTitle1: 'ברוכים הבאים ל-Captivela Office',
    ...
    onbBody2:
      'Captivela Office עדיין בגרסת אלפא. הצטרפו לצ׳אט הקבוצתי ב-Captivela Community כדי לשתף משוב ולעזור לעצב את ההמשך.',
    onbCredits: 'תורמים פעילים מקבלים **1,000+ נקודות Captivela**',
    onbJoinGenTeam: 'הצטרפו ל-Captivela Community',
    onbSkip: 'דילוג',
    onbNext: 'הבא',
    onbStart: 'להתחיל',
    ...
    onbNote3: 'תכונות AI עשויות לצרוך קרדיטים של Captivela.',
    onbBack: 'חזרה',
  },
  hi: {
    navRecent: 'हाल के',
    ...
    noContent: '(खाली)',
    accountGenspark: 'Captivela खाता',
    account: 'खाता',
    login: 'साइन इन करें',
    loginGenspark: 'Captivela से साइन इन करें',
    loggedIn: 'साइन इन हो गया',
    loggedInGenspark: 'Captivela में साइन इन है',
    waitingLogin:
    ...
    loginNetworkError: 'Captivela से कनेक्ट नहीं हो सका — नेटवर्क या प्रॉक्सी सेटिंग जांचें',
    ...
    newTab: 'नया टैब',
    // First-run onboarding
    onbTitle1: 'Captivela Office में आपका स्वागत है',
    ...
    onbBody2:
      'Captivela Office अभी अल्फ़ा में है। Captivela Community पर ग्रुप चैट से जुड़ें, फ़ीडबैक साझा करें और आगे की दिशा तय करने में मदद करें।',
    onbCredits: 'सक्रिय योगदानकर्ताओं के लिए **1,000+ Captivela क्रेडिट**',
    onbJoinGenTeam: 'Captivela Community से जुड़ें',
    onbSkip: 'छोड़ें',
    onbNext: 'आगे',
    onbStart: 'शुरू करें',
    ...
    onbNote3: 'AI सुविधाएँ Captivela क्रेडिट खर्च कर सकती हैं।',
    onbBack: 'वापस',
  },
  'zh-TW': {
    navRecent: '最近',
    ...
    untitled: '未命名',
    noContent: '（無內容）',
    accountGenspark: 'Captivela 帳號',
    account: '帳號',
    login: '登入',
    loginGenspark: '登入 Captivela 帳號',
    loggedIn: '已登入',
    loggedInGenspark: '已登入 Captivela',
    ...
    loginCopyUrl: '複製登入連結',
    loginCopied: '已複製',
    loginNetworkError: '無法連線至 Captivela，請檢查網路或代理設定',
    ...
    newTab: '新分頁',
    // First-run onboarding
    onbTitle1: '歡迎使用 Captivela Office',
    onbSubtitle1: '第一個開源的 AI 原生 Office 套件',
    onbBody1: '建立文件、製作試算表、產生簡報、審閱 PDF。AI 深度融入每個環節。',
    onbTitle2: '這只是一個開始',
    onbBody2:
      'Captivela Office 目前仍在 alpha 階段。歡迎加入 Captivela Community 群聊，分享回饋，一起打造它的未來。',
    onbCredits: '活躍貢獻者可獲得 **1,000+ Captivela 點數**',
    onbJoinGenTeam: '加入 Captivela Community',
    onbSkip: '略過',
    onbNext: '下一步',
    onbStart: '開始使用',
    ...
    onbNote3: 'AI 功能可能消耗 Captivela 點數。',
    onbBack: '上一步',
  },
} as const
