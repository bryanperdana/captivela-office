...
export const aiStrings = defineStrings({
  zh: {
    ...
    aiGskLoginBtn: '登录 hosted service',
    ...
    aiGensparkAccount: 'hosted service 账号',
    aiAccountChecking: '检测中…',
    aiLoggedIn: '已登录',
    aiLoggedInAs: '已登录：{email}',
    aiNotLoggedIn: '未登录（AI 功能需要登录 hosted service 账号）',
    aiWaitingBrowserLogin: '等待浏览器登录…',
    aiLoginGenspark: '登录 hosted service',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '保存',
    aiUnknownError: '未知错误',
    aiTimeoutError: 'AI 请求超时：网络长时间无响应，已停止。请检查网络后重试',
    aiCreditsExhausted: 'hosted service 积分已用完，请前往 the provider billing page 充值后重试',
  ...
  en: {
    ...
    aiGskLoginBtn: 'Sign in to hosted service',
    ...
    aiGensparkAccount: 'hosted service account',
    aiAccountChecking: 'Checking…',
    aiLoggedIn: 'Signed in',
    aiLoggedInAs: 'Signed in: {email}',
    aiNotLoggedIn: 'Not signed in (AI features require a hosted service account)',
    aiWaitingBrowserLogin: 'Waiting for browser sign-in…',
    aiLoginGenspark: 'Sign in to hosted service',
    aiModel: 'Model',
    aiCancel: 'Cancel',
    aiSave: 'Save',
    ...
    aiCreditsExhausted:
      'Your hosted service credits have run out. Visit the provider billing page to top up, then try again',
  ...
  ja: {
    ...
    aiGskLoginBtn: 'hosted service にサインイン',
    ...
    aiGensparkAccount: 'hosted service アカウント',
    aiAccountChecking: '確認中…',
    aiLoggedIn: 'サインイン済み',
    aiLoggedInAs: 'サインイン済み: {email}',
    aiNotLoggedIn: '未サインイン（AI 機能には hosted service アカウントへのサインインが必要です）',
    aiWaitingBrowserLogin: 'ブラウザーでのサインインを待機中…',
    aiLoginGenspark: 'hosted service にサインイン',
    aiModel: 'モデル',
    aiCancel: 'キャンセル',
    aiSave: '保存',
    ...
    aiCreditsExhausted:
      'hosted serviceクレジットを使い切りました。the provider billing page でチャージしてから再試行してください',
  ...
  ko: {
    ...
    aiGskLoginBtn: 'hosted service 로그인',
    ...
    aiGensparkAccount: 'hosted service 계정',
    aiAccountChecking: '확인 중…',
    aiLoggedIn: '로그인됨',
    aiLoggedInAs: '로그인됨: {email}',
    aiNotLoggedIn: '로그인되지 않음(AI 기능을 사용하려면 hosted service 계정 로그인이 필요합니다)',
    aiWaitingBrowserLogin: '브라우저 로그인 대기 중…',
    aiLoginGenspark: 'hosted service 로그인',
    aiModel: '모델',
    aiCancel: '취소',
    aiSave: '저장',
    ...
    aiCreditsExhausted:
      'hosted service 크레딧을 모두 사용했습니다. the provider billing page에서 충전한 후 다시 시도해 주세요',
  ...
  fr: {
    ...
    aiGskLoginBtn: 'Se connecter à hosted service',
    ...
    aiGensparkAccount: 'Compte hosted service',
    aiAccountChecking: 'Vérification…',
    aiLoggedIn: 'Connecté',
    aiLoggedInAs: 'Connecté : {email}',
    aiNotLoggedIn: 'Non connecté (les fonctions IA nécessitent un compte hosted service)',
    aiWaitingBrowserLogin: 'En attente de la connexion dans le navigateur…',
    aiLoginGenspark: 'Se connecter à hosted service',
    aiModel: 'Modèle',
    aiCancel: 'Annuler',
    aiSave: 'Enregistrer',
    ...
    aiCreditsExhausted:
      'Vos crédits hosted service sont épuisés. Rechargez sur the provider billing page puis réessayez',
  ...
  de: {
    ...
    aiGskLoginBtn: 'Bei hosted service anmelden',
    ...
    aiGensparkAccount: 'hosted service-Konto',
    aiAccountChecking: 'Wird überprüft…',
    aiLoggedIn: 'Angemeldet',
    aiLoggedInAs: 'Angemeldet: {email}',
    aiNotLoggedIn: 'Nicht angemeldet (KI-Funktionen erfordern ein hosted service-Konto)',
    aiWaitingBrowserLogin: 'Warten auf Anmeldung im Browser…',
    aiLoginGenspark: 'Bei hosted service anmelden',
    aiModel: 'Modell',
    aiCancel: 'Abbrechen',
    aiSave: 'Speichern',
    ...
    aiCreditsExhausted:
      'Deine hosted service-Credits sind aufgebraucht. Lade unter the provider billing page auf und versuche es erneut',
  ...
  es: {
    ...
    aiGskLoginBtn: 'Iniciar sesión en hosted service',
    ...
    aiGensparkAccount: 'Cuenta de hosted service',
    aiAccountChecking: 'Comprobando…',
    aiLoggedIn: 'Sesión iniciada',
    aiLoggedInAs: 'Sesión iniciada: {email}',
    aiNotLoggedIn:
      'Sin sesión iniciada (las funciones de IA requieren una cuenta de hosted service)',
    aiWaitingBrowserLogin: 'Esperando el inicio de sesión en el navegador…',
    aiLoginGenspark: 'Iniciar sesión en hosted service',
    aiModel: 'Modelo',
    aiCancel: 'Cancelar',
    aiSave: 'Guardar',
    ...
    aiCreditsExhausted:
      'Tus créditos de hosted service se han agotado. Recarga en the provider billing page e inténtalo de nuevo',
  ...
  th: {
    ...
    aiGskLoginBtn: 'ลงชื่อเข้าใช้ hosted service',
    ...
    aiGensparkAccount: 'บัญชี hosted service',
    aiAccountChecking: 'กำลังตรวจสอบ…',
    aiLoggedIn: 'ลงชื่อเข้าใช้แล้ว',
    aiLoggedInAs: 'ลงชื่อเข้าใช้แล้ว: {email}',
    aiNotLoggedIn: 'ยังไม่ได้ลงชื่อเข้าใช้ (ฟีเจอร์ AI ต้องใช้บัญชี hosted service)',
    aiWaitingBrowserLogin: 'กำลังรอการลงชื่อเข้าใช้ในเบราว์เซอร์…',
    aiLoginGenspark: 'ลงชื่อเข้าใช้ hosted service',
    aiModel: 'โมเดล',
    aiCancel: 'ยกเลิก',
    aiSave: 'บันทึก',
    ...
    aiCreditsExhausted:
      'เครดิต hosted service ของคุณหมดแล้ว โปรดเติมเครดิตที่ the provider billing page แล้วลองใหม่',
  ...
  id: {
    ...
    aiGskLoginBtn: 'Masuk ke hosted service',
    ...
    aiGensparkAccount: 'Akun hosted service',
    aiAccountChecking: 'Memeriksa…',
    aiLoggedIn: 'Sudah masuk',
    aiLoggedInAs: 'Sudah masuk: {email}',
    aiNotLoggedIn: 'Belum masuk (fitur AI memerlukan akun hosted service)',
    aiWaitingBrowserLogin: 'Menunggu proses masuk di browser…',
    aiLoginGenspark: 'Masuk ke hosted service',
    aiModel: 'Model',
    aiCancel: 'Batal',
    aiSave: 'Simpan',
    ...
    aiCreditsExhausted:
      'Kredit hosted service Anda telah habis. Isi ulang di the provider billing page lalu coba lagi',
  ...
  ru: {
    ...
    aiGskLoginBtn: 'Войти в hosted service',
    ...
    aiGensparkAccount: 'Учётная запись hosted service',
    aiAccountChecking: 'Проверка…',
    aiLoggedIn: 'Вход выполнен',
    aiLoggedInAs: 'Вход выполнен: {email}',
    aiNotLoggedIn: 'Вход не выполнен (для функций ИИ требуется учётная запись hosted service)',
    aiWaitingBrowserLogin: 'Ожидание входа в браузере…',
    aiLoginGenspark: 'Войти в hosted service',
    aiModel: 'Модель',
    aiCancel: 'Отмена',
    aiSave: 'Сохранить',
    ...
    aiCreditsExhausted:
      'Кредиты hosted service исчерпаны. Пополните баланс на the provider billing page и повторите попытку',
  ...
  ar: {
    ...
    aiGskLoginBtn: 'تسجيل الدخول إلى hosted service',
    ...
    aiGensparkAccount: 'حساب hosted service',
    aiAccountChecking: 'جارٍ التحقق…',
    aiLoggedIn: 'تم تسجيل الدخول',
    aiLoggedInAs: 'تم تسجيل الدخول: {email}',
    aiNotLoggedIn: 'لم يتم تسجيل الدخول (تتطلب ميزات الذكاء الاصطناعي حساب hosted service)',
    aiWaitingBrowserLogin: 'في انتظار تسجيل الدخول من المتصفح…',
    aiLoginGenspark: 'تسجيل الدخول إلى hosted service',
    aiModel: 'النموذج',
    aiCancel: 'إلغاء',
    aiSave: 'حفظ',
    ...
    aiCreditsExhausted:
      'نفدت أرصدة hosted service لديك. يرجى إعادة الشحن عبر the provider billing page ثم المحاولة مجددًا',
  ...
  pt: {
    ...
    aiGskLoginBtn: 'Entrar no hosted service',
    ...
    aiGensparkAccount: 'Conta hosted service',
    aiAccountChecking: 'Verificando…',
    aiLoggedIn: 'Conectado',
    aiLoggedInAs: 'Conectado: {email}',
    aiNotLoggedIn: 'Não conectado (os recursos de IA exigem uma conta hosted service)',
    aiWaitingBrowserLogin: 'Aguardando login no navegador…',
    aiLoginGenspark: 'Entrar no hosted service',
    aiModel: 'Modelo',
    aiCancel: 'Cancelar',
    aiSave: 'Salvar',
    ...
    aiCreditsExhausted:
      'Seus créditos hosted service acabaram. Recarregue em the provider billing page e tente novamente',
  ...
  it: {
    ...
    aiGskLoginBtn: 'Accedi a hosted service',
    ...
    aiGensparkAccount: 'Account hosted service',
    aiAccountChecking: 'Verifica in corso…',
    aiLoggedIn: 'Accesso effettuato',
    aiLoggedInAs: 'Accesso effettuato: {email}',
    aiNotLoggedIn: 'Accesso non effettuato (le funzioni IA richiedono un account hosted service)',
    aiWaitingBrowserLogin: "In attesa dell'accesso nel browser…",
    aiLoginGenspark: 'Accedi a hosted service',
    aiModel: 'Modello',
    aiCancel: 'Annulla',
    aiSave: 'Salva',
    ...
    aiCreditsExhausted:
      'I tuoi crediti hosted service sono esauriti. Ricarica su the provider billing page e riprova',
  ...
  pl: {
    ...
    aiGskLoginBtn: 'Zaloguj się do hosted service',
    ...
    aiGensparkAccount: 'Konto hosted service',
    aiAccountChecking: 'Sprawdzanie…',
    aiLoggedIn: 'Zalogowano',
    aiLoggedInAs: 'Zalogowano: {email}',
    aiNotLoggedIn: 'Nie zalogowano (funkcje AI wymagają konta hosted service)',
    aiWaitingBrowserLogin: 'Oczekiwanie na logowanie w przeglądarce…',
    aiLoginGenspark: 'Zaloguj się do hosted service',
    aiModel: 'Model',
    aiCancel: 'Anuluj',
    aiSave: 'Zapisz',
    ...
    aiCreditsExhausted:
      'Twoje kredyty hosted service wyczerpały się. Doładuj konto na the provider billing page i spróbuj ponownie',
  ...
  nl: {
    ...
    aiGskLoginBtn: 'Aanmelden bij hosted service',
    ...
    aiNotLoggedIn: 'Niet aangemeld (AI-functies vereisen een hosted service-account)',
    aiWaitingBrowserLogin: 'Wachten op aanmelding in de browser…',
    aiLoginGenspark: 'Aanmelden bij hosted service',
    aiModel: 'Model',
    aiCancel: 'Annuleren',
    aiSave: 'Opslaan',
    ...
    aiCreditsExhausted:
      'Je hosted service-credits zijn op. Waardeer op via the provider billing page en probeer het opnieuw',
  ...
  ms: {
    ...
    aiGskLoginBtn: 'Log masuk ke hosted service',
    ...
    aiGensparkAccount: 'Akaun hosted service',
    aiAccountChecking: 'Sedang menyemak…',
    aiLoggedIn: 'Sudah log masuk',
    aiLoggedInAs: 'Sudah log masuk: {email}',
    aiNotLoggedIn: 'Belum log masuk (ciri AI memerlukan akaun hosted service)',
    aiWaitingBrowserLogin: 'Menunggu log masuk dalam pelayar…',
    aiLoginGenspark: 'Log masuk ke hosted service',
    aiModel: 'Model',
    aiCancel: 'Batal',
    aiSave: 'Simpan',
    ...
    aiCreditsExhausted:
      'Kredit hosted service anda telah habis. Tambah nilai di the provider billing page dan cuba lagi',
  ...
  he: {
    ...
    aiGskLoginBtn: 'התחבר ל-hosted service',
    ...
    aiGensparkAccount: 'חשבון hosted service',
    aiAccountChecking: 'בודק…',
    aiLoggedIn: 'מחובר',
    aiLoggedInAs: 'מחובר: {email}',
    aiNotLoggedIn: 'לא מחובר (תכונות AI דורשות חשבון hosted service)',
    aiWaitingBrowserLogin: 'ממתין לכניסה בדפדפן…',
    aiLoginGenspark: 'כניסה ל-hosted service',
    aiModel: 'מודל',
    aiCancel: 'ביטול',
    aiSave: 'שמירה',
    ...
    aiCreditsExhausted:
      'קרדיטי hosted service שלך אזלו. טען מחדש ב-the provider billing page ונסה שוב',
  ...
  hi: {
    ...
    aiGskLoginBtn: 'hosted service में साइन इन करें',
    ...
    aiGensparkAccount: 'hosted service खाता',
    aiAccountChecking: 'जांच हो रही है…',
    aiLoggedIn: 'साइन इन किया गया',
    aiLoggedInAs: 'साइन इन: {email}',
    aiNotLoggedIn: 'साइन इन नहीं है (AI सुविधाओं के लिए hosted service खाता आवश्यक है)',
    aiWaitingBrowserLogin: 'ब्राउज़र में साइन इन की प्रतीक्षा…',
    aiLoginGenspark: 'hosted service में साइन इन करें',
    aiModel: 'मॉडल',
    aiCancel: 'रद्द करें',
    aiSave: 'सहेजें',
    ...
    aiCreditsExhausted:
      'आपके hosted service क्रेडिट समाप्त हो गए हैं। the provider billing page पर रिचार्ज करें और फिर से प्रयास करें',
  ...
  'zh-TW': {
    ...
    aiGskLoginBtn: '登入 hosted service',
    ...
    aiGensparkAccount: 'hosted service 帳號',
    aiAccountChecking: '偵測中…',
    aiLoggedIn: '已登入',
    aiLoggedInAs: '已登入：{email}',
    aiNotLoggedIn: '未登入（AI 功能需要登入 hosted service 帳號）',
    aiWaitingBrowserLogin: '等待瀏覽器登入…',
    aiLoginGenspark: '登入 hosted service',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '儲存',
    aiUnknownError: '未知錯誤',
    aiTimeoutError: 'AI 請求逾時：網路長時間無回應，已停止。請檢查網路後重試',
    aiCreditsExhausted: 'hosted service 點數已用完，請前往 the provider billing page 儲值後重試',
