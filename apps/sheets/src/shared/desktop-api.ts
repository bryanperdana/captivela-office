...
export interface DesktopApi {
  ...
  /// hosted service account status (gsk login state); withEmail also returns the email
  /// (needs a network request, slower)
  aiGskStatus(withEmail?: boolean): Promise<GenSparkAccountStatus>
  /// Opens the browser to sign in to hosted service (fire-and-forget; aiGskStatus
