...
/** File-type icons for attachment cards (hosted service attachment icon set); exts the
...
export function AiPanel({
  ...
  /** data-URL previews for image attachments, keyed by path (hosted service composer thumbnails) */
