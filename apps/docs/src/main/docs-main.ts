...
const tMain = createI18n({
  zh: {
    ...
    errGskNotLoggedIn: '未登录 hosted service:请点击下方「登录 hosted service」完成登录后重试',
    ...
    menuWindow: '窗口',
    menuHelp: '帮助',
    menuDocsHelp: 'Captivela Docs 帮助',
  },
  en: {
    ...
    errGskNotLoggedIn:
      'Not signed in to hosted service: click “Sign in to hosted service” below, sign in, then retry',
    ...
    menuWindow: 'Window',
    menuHelp: 'Help',
    menuDocsHelp: 'Captivela Docs Help',
  },
  ja: {
    dlgOpenDoc: '文書を開く',
    filterWord: 'Word 文書',
    ...
    errGskNotLoggedIn:
      'hosted service にサインインしていません。下の「hosted service にサインイン」からサインインして再試行してください',
    ...
    menuWindow: 'ウィンドウ',
    menuHelp: 'ヘルプ',
    menuDocsHelp: 'Captivela Docs ヘルプ',
  },
  ko: {
    dlgOpenDoc: '문서 열기',
    filterWord: 'Word 문서',
    ...
    errGskNotLoggedIn:
      'hosted service에 로그인되어 있지 않습니다. 아래 "hosted service 로그인"을 눌러 로그인한 뒤 다시 시도하세요',
    ...
    menuWindow: '창',
    menuHelp: '도움말',
    menuDocsHelp: 'Captivela Docs 도움말',
  },
  fr: {
    ...
    errGskNotLoggedIn:
      'Non connecté à hosted service : cliquez sur « Se connecter à hosted service » ci-dessous, connectez-vous puis réessayez',
    ...
    menuWindow: 'Fenêtre',
    menuHelp: 'Aide',
    menuDocsHelp: 'Aide Captivela Docs',
  },
  de: {
    ...
    errGskNotLoggedIn:
      'Nicht bei hosted service angemeldet: Klicken Sie unten auf „Bei hosted service anmelden“, melden Sie sich an und versuchen Sie es erneut',
    ...
    menuWindow: 'Fenster',
    menuHelp: 'Hilfe',
    menuDocsHelp: 'Captivela Docs-Hilfe',
  },
  es: {
    ...
    errGskNotLoggedIn:
      'No has iniciado sesión en hosted service: pulsa «Iniciar sesión en hosted service» abajo, inicia sesión y vuelve a intentarlo',
    ...
    menuWindow: 'Ventana',
    menuHelp: 'Ayuda',
    menuDocsHelp: 'Ayuda de Captivela Docs',
  },
  th: {
    ...
    errGskNotLoggedIn:
      'ยังไม่ได้ลงชื่อเข้าใช้ hosted service: แตะ “ลงชื่อเข้าใช้ hosted service” ด้านล่าง แล้วลองอีกครั้ง',
    ...
    menuWindow: 'หน้าต่าง',
    menuHelp: 'วิธีใช้',
    menuDocsHelp: 'วิธีใช้ Captivela Docs',
  },
  id: {
    ...
    errGskNotLoggedIn:
      'Belum masuk ke hosted service: klik “Masuk ke hosted service” di bawah, lalu coba lagi',
    ...
    menuWindow: 'Jendela',
    menuHelp: 'Bantuan',
    menuDocsHelp: 'Bantuan Captivela Docs',
  },
  ru: {
    ...
    errGskNotLoggedIn:
      'Вы не вошли в hosted service: нажмите «Войти в hosted service» ниже, войдите и повторите попытку',
    ...
    menuWindow: 'Окно',
    menuHelp: 'Справка',
    menuDocsHelp: 'Справка Captivela Docs',
  },
  ar: {
    ...
    errGskNotLoggedIn:
      'لم تسجّل الدخول إلى hosted service: انقر على «تسجيل الدخول إلى hosted service» أدناه ثم أعد المحاولة',
    ...
    menuWindow: 'نافذة',
    menuHelp: 'تعليمات',
    menuDocsHelp: 'تعليمات Captivela Docs',
  },
  pt: {
    dlgOpenDoc: 'Abrir Documento',
    ...
    errGskNotLoggedIn:
      'Não conectado ao hosted service: clique em “Entrar no hosted service” abaixo, entre e tente novamente',
    ...
    menuWindow: 'Janela',
    menuHelp: 'Ajuda',
    menuDocsHelp: 'Ajuda do Captivela Docs',
  },
  it: {
    ...
    errGskNotLoggedIn:
      'Accesso a hosted service non effettuato: fai clic su “Accedi a hosted service” qui sotto, accedi e riprova',
    ...
    menuWindow: 'Finestra',
    menuHelp: 'Aiuto',
    menuDocsHelp: 'Guida di Captivela Docs',
  },
  pl: {
    ...
    errGskNotLoggedIn:
      'Nie zalogowano do hosted service: kliknij „Zaloguj się do hosted service” poniżej, zaloguj się i spróbuj ponownie',
    ...
    menuWindow: 'Okno',
    menuHelp: 'Pomoc',
    menuDocsHelp: 'Pomoc Captivela Docs',
  },
  nl: {
    ...
    errGskNotLoggedIn:
      'Niet aangemeld bij hosted service: klik hieronder op “Aanmelden bij hosted service”, meld u aan en probeer het opnieuw',
  ...
  ms: {
    ...
    errGskNotLoggedIn:
      'Belum log masuk ke hosted service: klik “Log masuk ke hosted service” di bawah, kemudian cuba lagi',
  ...
  he: {
    ...
    errGskNotLoggedIn:
      'לא מחובר ל-hosted service: לחץ על "התחבר ל-hosted service" למטה, התחבר ונסה שוב',
    ...
    menuWindow: 'חלון',
    menuHelp: 'עזרה',
    menuDocsHelp: 'עזרה של Captivela Docs',
  },
  hi: {
    ...
    errGskNotLoggedIn:
      'hosted service में साइन इन नहीं है: नीचे “hosted service में साइन इन करें” पर क्लिक करें, साइन इन करें और फिर से कोशिश करें',
    ...
    menuWindow: 'विंडो',
    menuHelp: 'सहायता',
    menuDocsHelp: 'Captivela Docs सहायता',
  },
  'zh-TW': {
    dlgOpenDoc: '開啟文件',
    filterWord: 'Word 文件',
    ...
    errGskNotLoggedIn: '未登入 hosted service:請點擊下方「登入 hosted service」完成登入後重試',
    ...
    menuWindow: '視窗',
    menuHelp: '說明',
    menuDocsHelp: 'Captivela Docs 說明',
  },
})
...
/**
 * hosted service account state. With `GENSPARK_CLOUD_ENABLED` off (the BYOK build)
 * this always reports signed-out, so no surface can gate an AI feature on a
 * hosted service login.
 */
